           ...
           <form @submit.prevent="signup()">
               ...
               <div class="form-group">
                  ...
                  <select class="form-control" id="inlineFormCustomSelect" v-model="account_type">
                            ...
                            <option value="500,000 gold jackpot">&#8358;500,000 to &#8358;1,500,000 (Promo plan)</option>
                            ...
                            <option value="1,000,000 gold jackpot">&#8358;1,000,000 to &#8358;3,000,000 (gold jackpot)</option>
                         </select>
               </div>
               <div class="form-group">
